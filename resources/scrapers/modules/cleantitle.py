...
def get(title):
	try:
		...
		log(f"Error in get function: {title}", LOGERROR)
		return title
...
def get_simple(title):
	try:
		...
		log(f"Error in get_simple function: {title}", LOGERROR)
		return title
...
def geturl(title):
	...
	try:
		...
		log(f"Error in geturl function: {title}", LOGERROR)
		return title
...
def normalize(title):
	try:
		...
		log(f"Error in normalize function: {title}", LOGERROR)
		return title