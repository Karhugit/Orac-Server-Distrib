...
def parseDOM(html, name='', attrs=None, ret=False):
	try:
		...
		log_utils.log("Error in parseDOM", level=log_utils.LOGERROR)
...
def __get_dom_content(html, name, match):
	try:
		...
		from resources.lib import log_utils
		log_utils.log("Error in parse_dom", level=log_utils.LOGERROR)
		return ''
...
def __get_dom_elements(item, name, attrs):
	try:
		...
		from resources.lib import log_utils
		log_utils.log("Error in __get_dom_elements", level=log_utils.LOGERROR)
		return this_list
...
def __get_attribs(element):
	try:
		...
		from resources.lib import log_utils
		log_utils.log("Error in __get_attribs", level=log_utils.LOGERROR)
		return attribs
