...
from resources.scrapers.modules.control import existsPath, dataPath, makeFile, undesirablescacheFile, lang
...
def undesirablesSelect():
	from resources.scrapers.modules.control import multiselectDialog
	from resources.scrapers.modules.source_utils import UNDESIRABLES
...
def undesirablesUserRemove():
	from resources.scrapers.modules.control import multiselectDialog, notification
	undesirables_cache = Undesirables()
...
def undesirablesUserRemoveAll():
	from resources.scrapers.modules.control import yesnoDialog, notification
	undesirables_cache = Undesirables()
	user_undesirables = undesirables_cache.get_user_defined()
	if not user_undesirables: return notification(message=32084)
...
def undesirablesInput():
	from resources.scrapers.modules.control import dialog
	undesirables_cache = Undesirables()
